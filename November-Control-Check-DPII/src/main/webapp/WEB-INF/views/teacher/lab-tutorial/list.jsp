...
<acme:list>
	<acme:list-column code="teacher.lab-tutorial.list.label.title" path="title" width="30%"/>	
	<acme:list-column code="teacher.lab-tutorial.list.label.abstractText" path="abstractText" width="70%"/>
</acme:list>
