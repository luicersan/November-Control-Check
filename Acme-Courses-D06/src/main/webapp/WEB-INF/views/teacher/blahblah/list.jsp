...
<acme:list>
	<acme:list-column code="teacher.blahblah.list.label.ticker" path="ticker" width="30%"/>
	<acme:list-column code="teacher.blahblah.list.label.caption" path="caption" width="70%"/>	
</acme:list>
