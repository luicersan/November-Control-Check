...
//	Lusit findOneBlahblahById(@Param("id") int id);
//	
//	@Query("select b from Blahblah b where b.theoryTutorial.id = :id")
//	Lusit findOneBlahblahByTheoryTutorialId(@Param("id") int id);
//
...
//	Collection<Lusit> findManyBlahblahsByTeacher(@Param("id") int id);
//
...
//	Collection<Lusit> findAllBlahblahs();
//
//}
